...
# XXD Panel 207｜صفحة كولاج بوسائط مختلطة وأزرق فاتح
...
صفحة كولاج بوسائط مختلطة وأزرق فاتح
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 207 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-207`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-207 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-207-prompt.en.md) أو [بالصينية](references/xxd-panel-207-prompt.zh-CN.md).
